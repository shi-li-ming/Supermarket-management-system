<template>
    <div>
        ...
        <div class="ms-doc">
            ...
            <article>
                <h1>manage-system</h1>
                <p>基于Vue.js 2.x系列 + Element UI + Node.js + MySQL的超市管理系统</p>
                <h2>前言</h2>
                <p>用了Vue + Element组件库做了个登录管理系统，包括注册，登录，个人中心，用户管理，分类管理，商品管理，进货管理，出货管理几个功能模块。</p>
                ...
                <br>
                <el-checkbox disabled checked>设置</el-checkbox>
                <br>
                ...
                <br>
                 <el-checkbox disabled checked>进货管理</el-checkbox>
                <br>
                 <el-checkbox disabled checked>出货管理</el-checkbox>
                <br>
                <h2>安装步骤</h2>
                <p>cd vue-login-manage-system-master //进入项目目录</p>
                <p>npm install //安装项目依赖，等待安装完成</p>
                <h2>本地开发</h2>
                <p>//开启前端服务，浏览器访问 http://localhost:8086</p>
                <p>npm run dev</p>
                <p>//开启后端服务</p>
                <p>cd vue-login-manage-system-master</p>
                <p>node app.js</p>
                <h2>设置代理与跨域</h2>
